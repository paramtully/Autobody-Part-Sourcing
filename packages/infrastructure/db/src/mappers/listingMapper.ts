...
export function toDomainListing(data: ListingAggregateData): Listing {
    ...
    return {
        ...
        sourceVehicleVin: listing.sourceVehicleVin ?? undefined,
        sourceMileage: listing.sourceMileage ?? undefined,
        sourceDamageType: listing.sourceDamageType ?? undefined,
...
export function toDbListingInsert(
    ...
    return {
        ...
        sourceVehicleVin: listing.sourceVehicleVin ?? null,
        sourceMileage: listing.sourceMileage ?? null,
        sourceDamageType: listing.sourceDamageType ?? null,
